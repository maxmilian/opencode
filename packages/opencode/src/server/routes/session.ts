  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all StaffAI sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific StaffAI session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new StaffAI session for interacting with AI assistants and managing conversations.",
