...
const docs = `### Overview
Loads StaffAI typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>StaffAI Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>StaffAI Mono Sample</div>
    </div>
  ),
}
