...
export const dict = {
  ...
  "dialog.provider.staffai.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.staffai.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.staffaiGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "StaffAI tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve StaffAI'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.staffaiZen.line1":
    "StaffAI Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.staffaiZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve StaffAI'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak StaffAI'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler staffai.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi StaffAI sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "StaffAI'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı StaffAI ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (staffai.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: StaffAI henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "StaffAI ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "StaffAI Masaüstü",
  ...
  "settings.desktop.wsl.description": "StaffAI sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "StaffAI'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "StaffAI'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "StaffAI'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "StaffAI'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "StaffAI başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "StaffAI'un en son sürümünü kullanıyorsunuz.",
