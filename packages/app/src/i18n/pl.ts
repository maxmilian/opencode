export const dict = {
  ...
  "dialog.provider.staffai.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.staffai.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.staffaiGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez StaffAI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w StaffAI.",
  ...
  "provider.connect.staffaiZen.line1":
    "StaffAI Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.staffaiZen.visit.prefix": "Odwiedź ",
  "provider.connect.staffaiZen.visit.link": "staffai.ai/zen",
  "provider.connect.staffaiZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w StaffAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w StaffAI.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w staffai.json",
  ...
  "dialog.server.description": "Przełącz serwer StaffAI, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja StaffAI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu StaffAI",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (staffai.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "StaffAI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla StaffAI",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd StaffAI na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy StaffAI ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw StaffAI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania StaffAI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji StaffAI.",
