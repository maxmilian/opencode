export const dict = {
  ...
  "dialog.provider.staffai.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.staffai.tagline": "Reliable optimized models",
  "dialog.provider.staffaiGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by StaffAI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in StaffAI.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.staffaiZen.line1":
    "StaffAI Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.staffaiZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.staffaiZen.visit.prefix": "Visit ",
  "provider.connect.staffaiZen.visit.link": "staffai.ai/zen",
  "provider.connect.staffaiZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in StaffAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in StaffAI.",
  ...
  "dialog.plugins.empty": "Plugins configured in staffai.json",
  ...
  "dialog.server.description": "Switch which StaffAI server this app connects to.",
  ...
  "toast.update.description": "A new version of StaffAI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the StaffAI team",
  ...
  "error.chain.checkConfig": "Check your config (staffai.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, StaffAI does not support MCP authentication yet.',
  ...
  "home.subtitle": "Your Intelligent Chief of Staff.",
  "home.nextCommand": "Your Next Command",
  "home.askAnything": "Ask anything...",
  "home.skill.companyInvestigation": "Company Investigation",
  "home.skill.companyInvestigation.desc": "Try \"Investigate TSMC\"",
  "home.skill.dataAnalysis": "Data Analysis Workflow",
  "home.skill.dataAnalysis.desc": "Try \"Analyze Q3 financial reports\"",
  "home.skill.reportSummary": "Weekly Report Summary",
  "home.skill.reportSummary.desc": "Summarize \"ZEUS Games weekly meeting notes\"",
  "home.skill.competitorResearch": "Competitor Market Research",
  "home.skill.competitorResearch.desc": "Analyze \"AIOTEK\" market opportunities",
  "home.quick.companyInvestigation": "Company Investigation",
  "home.quick.dataAnalysis": "Data Analysis",
  "home.quick.documentProcessing": "Document Processing",
  "home.quick.strategySimulation": "Strategy Simulation",
  "home.quick.imageAnalysis": "Image Analysis",
  ...
  "sidebar.gettingStarted.line1": "StaffAI includes free models so you can start immediately.",
  ...
  "app.name.desktop": "StaffAI Desktop",
  ...
  "settings.desktop.wsl.description": "Run the StaffAI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for StaffAI",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how StaffAI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether StaffAI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how StaffAI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when StaffAI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of StaffAI.",
