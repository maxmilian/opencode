...
export const dict = {
  ...
  "dialog.provider.staffai.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.staffai.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.staffaiGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av StaffAI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i StaffAI.",
  ...
  "provider.connect.staffaiZen.line1":
    "StaffAI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.staffaiZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.staffaiZen.visit.prefix": "Besøk ",
  "provider.connect.staffaiZen.visit.link": "staffai.ai/zen",
  "provider.connect.staffaiZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i StaffAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i StaffAI.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i staffai.json",
  ...
  "dialog.server.description": "Bytt hvilken StaffAI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av StaffAI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til StaffAI-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (staffai.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at StaffAI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "StaffAI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør StaffAI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for StaffAI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan StaffAI ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om StaffAI skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan StaffAI er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når StaffAI starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av StaffAI.",
