export const dict = {
  ...
  "dialog.provider.staffai.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.staffai.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.staffaiGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje StaffAI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u StaffAI-u.",
  ...
  "provider.connect.staffaiZen.line1":
    "StaffAI Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.staffaiZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.staffaiZen.visit.prefix": "Posjeti ",
  "provider.connect.staffaiZen.visit.link": "staffai.ai/zen",
  "provider.connect.staffaiZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u StaffAI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u StaffAI-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u staffai.json",
  ...
  "dialog.server.description": "Promijeni na koji se StaffAI server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija StaffAI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku StaffAI timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (staffai.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: StaffAI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "StaffAI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni StaffAI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u StaffAI-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako StaffAI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li StaffAI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu StaffAI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se StaffAI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju StaffAI-a.",
