export const dict = {
  ...
  "dialog.provider.staffai.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.staffai.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.staffaiGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "StaffAIが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、StaffAIで{{provider}}モデルを使用します。",
  ...
  "provider.connect.staffaiZen.line1":
    "StaffAI Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.staffaiZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.staffaiZen.visit.prefix": " ",
  "provider.connect.staffaiZen.visit.link": "staffai.ai/zen",
  "provider.connect.staffaiZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してStaffAIで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、StaffAIで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "staffai.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するStaffAIサーバーを切り替えます。",
  ...
  "toast.update.description": "StaffAIの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをStaffAIチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (staffai.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: StaffAIはまだMCP認証をサポートしていません。',
  ...
  "home.subtitle": "あなたのインテリジェント・チーフオブスタッフ。",
  "home.nextCommand": "次のコマンド",
  "home.askAnything": "何でも聞いてください…",
  "home.skill.companyInvestigation": "企業調査",
  "home.skill.companyInvestigation.desc": "「TSMCを調査して」と試す",
  "home.skill.dataAnalysis": "データ分析ワークフロー",
  "home.skill.dataAnalysis.desc": "「Q3決算報告を分析して」と試す",
  "home.skill.reportSummary": "週次レポートまとめ",
  "home.skill.reportSummary.desc": "「ZEUS Games週次会議メモ」をまとめる",
  "home.skill.competitorResearch": "競合市場調査",
  "home.skill.competitorResearch.desc": "「AIOTEK」の市場機会を分析",
  "home.quick.companyInvestigation": "企業調査",
  "home.quick.dataAnalysis": "データ分析",
  "home.quick.documentProcessing": "ドキュメント処理",
  "home.quick.strategySimulation": "戦略シミュレーション",
  "home.quick.imageAnalysis": "画像分析",
  ...
  "sidebar.gettingStarted.line1": "StaffAIには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でStaffAIサーバーを実行します。",
  ...
  "settings.general.row.language.description": "StaffAIの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのStaffAIの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "StaffAIがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "StaffAIのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "StaffAI の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "StaffAI は最新バージョンです。",
