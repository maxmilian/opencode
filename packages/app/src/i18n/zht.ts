...
export const dict = {
  ...
  "dialog.provider.staffai.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.staffai.tagline": "可靠的優化模型",
  "dialog.provider.staffaiGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "StaffAI 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 StaffAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.staffaiZen.line1": "StaffAI Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.staffaiZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.staffaiZen.visit.prefix": "造訪 ",
  "provider.connect.staffaiZen.visit.link": "staffai.ai/zen",
  "provider.connect.staffaiZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 StaffAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 StaffAI 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 staffai.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 StaffAI 伺服器。",
  ...
  "toast.update.description": "StaffAI 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 StaffAI 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (staffai.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: StaffAI 暫不支援 MCP 認證。',
  ...
  "home.subtitle": "你的智慧幕僚長。",
  "home.nextCommand": "下一步指令",
  "home.askAnything": "問任何問題⋯",
  "home.skill.companyInvestigation": "企業調查",
  "home.skill.companyInvestigation.desc": "試試「調查台積電」",
  "home.skill.dataAnalysis": "數據分析工作流",
  "home.skill.dataAnalysis.desc": "試試「分析 Q3 財報」",
  "home.skill.reportSummary": "週報摘要",
  "home.skill.reportSummary.desc": "摘要「ZEUS Games 週會紀錄」",
  "home.skill.competitorResearch": "競品市場調查",
  "home.skill.competitorResearch.desc": "分析「AIOTEK」市場機會",
  "home.quick.companyInvestigation": "企業調查",
  "home.quick.dataAnalysis": "數據分析",
  "home.quick.documentProcessing": "文件處理",
  "home.quick.strategySimulation": "策略模擬",
  "home.quick.imageAnalysis": "圖片分析",
  ...
  "sidebar.gettingStarted.line1": "StaffAI 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 StaffAI 伺服器。",
  ...
  "settings.general.row.language.description": "變更 StaffAI 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 StaffAI 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 StaffAI 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 StaffAI 的主題。",
  ...
  "settings.updates.row.startup.description": "在 StaffAI 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 StaffAI。",
