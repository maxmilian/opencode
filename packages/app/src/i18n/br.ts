export const dict = {
  ...
  "dialog.provider.staffai.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.staffai.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.staffaiGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo StaffAI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no StaffAI.",
  ...
  "provider.connect.staffaiZen.line1":
    "StaffAI Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.staffaiZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.staffaiZen.visit.prefix": "Visite ",
  "provider.connect.staffaiZen.visit.link": "staffai.ai/zen",
  "provider.connect.staffaiZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no StaffAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no StaffAI.",
  ...
  "dialog.plugins.empty": "Plugins configurados em staffai.json",
  ...
  "dialog.server.description": "Trocar para qual servidor StaffAI este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do StaffAI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do StaffAI",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (staffai.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: StaffAI ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "StaffAI inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor StaffAI dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do StaffAI",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o StaffAI aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o StaffAI segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o StaffAI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o StaffAI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do StaffAI.",
